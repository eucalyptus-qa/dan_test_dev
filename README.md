...
Eucalyptus's First Test -- Using EC2 tools, this testunit creates kaypairs, allocates IP, launches an instance, and terminates it. By Default, it runs 3 iterations.
